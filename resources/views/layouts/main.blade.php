          ...
          @section('sidebar')
            <div class="col-md-3 pull-left">
              ...
              <ul>
                ...
                <li><a href="/users"><span class="glyphicon glyphicon-th"></span> Users</a></li>
                <li><a href="/site"><span class="glyphicon glyphicon-th-large"></span> Introductory Text Editor</a></li>
                <li><a href="/posts"><span class="glyphicon glyphicon-th-list"></span> Posts</a></li>
                <li><a href="/categories"><span class="glyphicon glyphicon-folder-open"></span> Categories</a></li>
              </ul>
           </div>
          @show
